...
function Page() {
    ...
    useEffect(()=>{
        try {
            ...
            console.log("invalid receipt Id ", error)
            router.push("/")
        }
    },[params.id,router])
                ...
                <div className="p-6">
                    <div className="flex items-center justify-between mb-6">
                        <h1 className="text-2xl font-bold text-gray-900 truncate">
                            {receipt.fileDisplayName || receipt.fileName}</h1>
                            ...
                            <div className="flex items-center">
                                ...
                                className={`px-3 py-1 rounded-full text-sm ${
                                    receipt.status ==="pending"? "bg-yellow-100 text-yellow-800": receipt.status ==="processed"?"bg-green-100 text-green-800":"bg-red-100 text-red-800" 
                                }`}
                                >
                                                ...
                                                {isSummariesEnabled ?(
                                                   ...
                                                   <div className="ml-2 flex">
                                                    ...
                                                    <div className="mt-3 text-xs text-blue-600 italic flex items-center">
                                                        ...
                                                        <span>
                                                            AI generated summmary based on receipt data
                                                        </span>
                                                    ...
                                                    <div className="mt-6 bg-gray-100 p-6 rounded-lg border border-gray-200 shadow-sm">
                                                        ...
                                                        <div className="mt-3 text-sm text-gray-400 italic flex items-center">
                                                            <Lightbulb className="h-3 w-3 mr-1"/>
                                                                <span>
                                                                    Get AI powered insights from the receipt
                                                                </span>
                                                        </div>
                                    ...
                                    <Table>
                                        ...
                                        <TableFooter>
                                            ...
                                            <TableCell className="font-medium">
                                                {
                                                    formatCurrency(
                                                        receipt.items.reduce((sum,item)=>sum+item.totalPrice, 0), receipt.currency
                                                    )
                                                }
                                            </TableCell>
                                            </TableRow>

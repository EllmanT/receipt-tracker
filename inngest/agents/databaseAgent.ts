...
const saveToDatabase = createTool({
    ...
    parameters:z.object({
        ...
        z.string()
        .describe(
            "THe readable display name of the receipt to show in the UI. If the file name is not human readale use this to give a more readable name"
        ),
        ...
        transactionAmount:z.string().describe("THe total amount of the transaction, summing all of the items on the receipt"),
        ...
        items:z.array(
            ...
            .describe("An array of items on the invoice Include the name , quantity , unit price and total price of each item")
        )
    }),
...
export const databaseAgent = createAgent({
    ...
    system:"You are a helpful assistatnt that takes key information regarding receipts and saves it to the convex database",
    model: openai({
        model:"gpt-4o-mini",
        defaultParameters:{
